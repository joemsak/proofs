...
var Upload = {
	...
	*/
	...
	
	{
		if (num_queued > 0)
		{
			...
			//alert($(this.customSettings.uploadButtonId).length);
			$(this.customSettings.uploadButtonId).removeClass('disabled')
				.attr('disabled', '');
		}
	},
	...
	*/
	file_queued: function(file)
	{
		...
		$(this.customSettings.progressTarget).prepend(div);
	},
	...
	*/
	upload_error: function(file, code, message)
	{
		...
		alert('Sorry, but an error occurred. You should let Joe know.');
	},
